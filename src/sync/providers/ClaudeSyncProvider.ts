// packages/core/src/sync/providers/ClaudeSyncProvider.ts
...
/**
 * SyncProvider implementation using the Claude API directly.
 * Uses the @anthropic-ai/sdk for sync operations.
 */
export class ClaudeSyncProvider implements SyncProvider {
